...
namespace BeatThat.Transitions
{
     ...
     */
        ...
        */
        ...
        public delegate int NumSlicesBetweenControlPointDelegate(Vector3 start, Vector3 end);
        ...
        public static Function Ease(EaseType type)
        {
            ...
            switch (type)
            {
                case EaseType.Linear: f = Interpolate.linearFunction; break;
                case EaseType.EaseInQuad: f = Interpolate.easeInQuadFunction; break;
                case EaseType.EaseOutQuad: f = Interpolate.easeOutQuadFunction; break;
                case EaseType.EaseInOutQuad: f = Interpolate.easeInOutQuadFunction; break;
                case EaseType.EaseInCubic: f = Interpolate.easeInCubicFunction; break;
                case EaseType.EaseOutCubic: f = Interpolate.easeOutCubicFunction; break;
                case EaseType.EaseInOutCubic: f = Interpolate.easeInOutCubicFunction; break;
                case EaseType.EaseInQuart: f = Interpolate.easeInQuartFunction; break;
                case EaseType.EaseOutQuart: f = Interpolate.easeOutQuartFunction; break;
                case EaseType.EaseInOutQuart: f = Interpolate.easeInOutQuartFunction; break;
                case EaseType.EaseInQuint: f = Interpolate.easeInQuintFunction; break;
                case EaseType.EaseOutQuint: f = Interpolate.easeOutQuintFunction; break;
                case EaseType.EaseInOutQuint: f = Interpolate.easeInOutQuintFunction; break;
                case EaseType.EaseInSine: f = Interpolate.easeInSineFunction; break;
                case EaseType.EaseOutSine: f = Interpolate.easeOutSineFunction; break;
                case EaseType.EaseInOutSine: f = Interpolate.easeInOutSineFunction; break;
                case EaseType.EaseInExpo: f = Interpolate.easeInExpoFunction; break;
                case EaseType.EaseOutExpo: f = Interpolate.easeOutExpoFunction; break;
                case EaseType.EaseInOutExpo: f = Interpolate.easeInOutExpoFunction; break;
                case EaseType.EaseInCirc: f = Interpolate.easeInCircFunction; break;
                case EaseType.EaseOutCirc: f = Interpolate.easeOutCircFunction; break;
                case EaseType.EaseInOutCirc: f = Interpolate.easeInOutCircFunction; break;
            }
            return f;
        }

        private static Function linearFunction { get { return m_linearFunction ?? (m_linearFunction = Interpolate.Linear); } }
        private static Function m_linearFunction;

        private static Function easeInQuadFunction { get { return m_easeInQuadFunction ?? (m_easeInQuadFunction = Interpolate.EaseInQuad); } }
        private static Function m_easeInQuadFunction;

        private static Function easeOutQuadFunction { get { return m_easeOutQuadFunction ?? (m_easeOutQuadFunction = Interpolate.EaseOutQuad); } }
        private static Function m_easeOutQuadFunction;

        private static Function easeInOutQuadFunction { get { return m_easeInOutQuadFunction ?? (m_easeInOutQuadFunction = Interpolate.EaseInOutQuad); } }
        private static Function m_easeInOutQuadFunction;

        private static Function easeInCubicFunction { get { return m_easeInCubicFunction ?? (m_easeInCubicFunction = Interpolate.EaseInCubic); } }
        private static Function m_easeInCubicFunction;

        private static Function easeOutCubicFunction { get { return m_easeOutCubicFunction ?? (m_easeOutCubicFunction = Interpolate.EaseOutCubic); } }
        private static Function m_easeOutCubicFunction;

        private static Function easeInOutCubicFunction { get { return m_easeInOutCubicFunction ?? (m_easeInOutCubicFunction = Interpolate.EaseInOutCubic); } }
        private static Function m_easeInOutCubicFunction;

        private static Function easeInQuartFunction { get { return m_easeInQuartFunction ?? (m_easeInQuartFunction = Interpolate.EaseInQuart); } }
        private static Function m_easeInQuartFunction;

        private static Function easeOutQuartFunction { get { return m_easeOutQuartFunction ?? (m_easeOutQuartFunction = Interpolate.EaseOutQuart); } }
        private static Function m_easeOutQuartFunction;

        private static Function easeInOutQuartFunction { get { return m_easeInOutQuartFunction ?? (m_easeInOutQuartFunction = Interpolate.EaseInOutQuart); } }
        private static Function m_easeInOutQuartFunction;

        private static Function easeInQuintFunction { get { return m_easeInQuintFunction ?? (m_easeInQuintFunction = Interpolate.EaseInQuint); } }
        private static Function m_easeInQuintFunction;

        private static Function easeOutQuintFunction { get { return m_easeOutQuintFunction ?? (m_easeOutQuintFunction = Interpolate.EaseOutQuint); } }
        private static Function m_easeOutQuintFunction;

        private static Function easeInOutQuintFunction { get { return m_easeInOutQuintFunction ?? (m_easeInOutQuintFunction = Interpolate.EaseInOutQuint); } }
        private static Function m_easeInOutQuintFunction;

        private static Function easeInSineFunction { get { return m_easeInSineFunction ?? (m_easeInSineFunction = Interpolate.EaseInSine); } }
        private static Function m_easeInSineFunction;

        private static Function easeOutSineFunction { get { return m_easeOutSineFunction ?? (m_easeOutSineFunction = Interpolate.EaseOutSine); } }
        private static Function m_easeOutSineFunction;

        private static Function easeInOutSineFunction { get { return m_easeInOutSineFunction ?? (m_easeInOutSineFunction = Interpolate.EaseInOutSine); } }
        private static Function m_easeInOutSineFunction;

        private static Function easeInExpoFunction { get { return m_easeInExpoFunction ?? (m_easeInExpoFunction = Interpolate.EaseInExpo); } }
        private static Function m_easeInExpoFunction;

        private static Function easeOutExpoFunction { get { return m_easeOutExpoFunction ?? (m_easeOutExpoFunction = Interpolate.EaseOutExpo); } }
        private static Function m_easeOutExpoFunction;

        private static Function easeInOutExpoFunction { get { return m_easeInOutExpoFunction ?? (m_easeInOutExpoFunction = Interpolate.EaseInOutExpo); } }
        private static Function m_easeInOutExpoFunction;

        private static Function easeInCircFunction { get { return m_easeInCircFunction ?? (m_easeInCircFunction = Interpolate.EaseInCirc); } }
        private static Function m_easeInCircFunction;

        private static Function easeOutCircFunction { get { return m_easeOutCircFunction ?? (m_easeOutCircFunction = Interpolate.EaseOutCirc); } }
        private static Function m_easeOutCircFunction;

        private static Function easeInOutCircFunction { get { return m_easeInOutCircFunction ?? (m_easeInOutCircFunction = Interpolate.EaseInOutCirc); } }
        private static Function m_easeInOutCircFunction;
        ...
        public static IEnumerable<Vector3> NewCatmullRom<T>(IList nodes, ToVector3<T> toVector3, NumSlicesBetweenControlPointDelegate numSlicesDel, bool loop)
        {
            // need at least two nodes to spline between
            if (nodes.Count >= 2)
            {
                ...
                for (int current = 0; loop || current < last; current++)
                {
                    ...
                    Vector3 prevNode = toVector3((T)nodes[previous]);
                    Vector3 startNode = toVector3((T)nodes[start]);
                    Vector3 endNode = toVector3((T)nodes[end]);
                    Vector3 nextNode = toVector3((T)nodes[next]);

                    // adding one guarantees yielding at least the end point
                    int stepCount = numSlicesDel(startNode, endNode) + 1;
                    for (int step = 1; step <= stepCount; step++)
                    {
                        yield return CatmullRom(prevNode, startNode, endNode, nextNode, step, stepCount);
                    }
                }
            }
        }
        ...
        public static float Linear(float start, float distance, float elapsedTime, float duration)
        {
            ...
            if (duration <= 0)
            {
                Debug.LogError("[" + Time.time + "] Duration " + duration + " should be greater than zero.");
            }
